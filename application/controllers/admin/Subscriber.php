...
class Subscriber extends BaseController
{
    ...
    public function index()
    {
        ...
        $this->loadViews("admin/subscriber/list", $this->global, NULL , NULL);
    ...
    public function addnew()
    {
        ...
        $this->global['pageTitle'] = 'Add New Sub Category';
        $this->loadViews("admin/subscriber/addnew", $this->global, $data , NULL);
    ...
    public function insertnow()
    {
        ...
        else
        {
            ...
            redirect('admin/subscriber/addnew');
          }  
    ...
    {
		$list = $this->subscriber_model->get_datatables();
        ...
        foreach ($list as $currentObj) {
            ...
            $row[] = $currentObj->email;
             $row[] = $currentObj->subscribe==1?'Subscribe':'';
            $row[] = $date_at;
            ...
            /*
            $row[] = '<a   class="btn btn-sm btn-info" href="'.base_url().'admin/subscriber/edit/'.$currentObj->id.'" title="Edit" ><i class="fa fa-pencil"></i></a>';*/
            $data[] = $row;
        }
		
        $output = array(
                        "draw" => (isset($_POST['draw']))?$_POST['draw']:'',
                        "recordsTotal" => $this->subscriber_model->count_all(),
                        "recordsFiltered" => $this->subscriber_model->count_filtered(),
                        "data" => $data,
                );
    ...
    public function edit($id = NULL)
    {
        ...
        $data['edit_data'] = $this->subscriber_model->find($id);
        $this->global['pageTitle'] = 'Edit Subscriber';
        $this->loadViews("admin/subscriber/edit", $this->global, $data , NULL);
    ...
    public function update()
    {
        ...
        else
        {
            ...
            redirect('admin/subscriber/edit/'.$insertData['id']);
          }  
