...
class Lists extends BaseController
{
     ...
     public function index()
    {
        ...
        $this->loadAgentViews("agent/lists/list", $this->global, $data , NULL);
     ...
     public function addnew()
    {
        ...
        $this->loadAgentViews("agent/lists/addnew", $this->global, $data , NULL);
...
public function insertnow()
            ...
            $insertData['update_at'] = date("Y-m-d H:i:s");
             $insertData['status'] = $form_data['status'];
              ...
              $result = $this->lists_model->save($insertData);
                ...
                redirect('agent/lists/edit/'.$form_data['id']);
...

    {
       ...
       /*     $row[] = '';*/
            ...
            $row[] = '<a class="btn btn-sm btn-info" href="'.base_url().'agent/lists/edit/'.$currentObj->id.'" title="Edit" >Edit</a>&nbsp;<a class="btn btn-sm btn-danger deletebtn" href="#" data-userid="'.$currentObj->id.'"><i class="fa fa-trash"></i></a>';
     ...
     public function edit($id = NULL)
    {
       ...
       $this->isAgentLoggedIn();
        ...
        $this->loadAgentViews("agent/lists/edit", $this->global, $data , NULL);
